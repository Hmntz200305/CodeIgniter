(function() {
    ...
    total.forEach(function(item, i) {
        var createMovingDiv = function() {
            var moving_div = document.createElement("div");
            var first_li = item.querySelector("li:first-child [data-tab-target]");
            var tab = first_li.cloneNode();
            tab.innerHTML = "-";
            tab.classList.remove("bg-rose-600", "text-slate-700");
            tab.classList.add("bg-rose-600", "text-white");
            tab.style.animation = ".2s ease";
            moving_div.classList.add("z-10", "absolute", "text-slate-700", "rounded-lg", "bg-rose-600", "flex-auto", "text-center", "bg-none", "border-0", "block", "shadow");
