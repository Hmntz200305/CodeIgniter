        ...
        <table id="usersData" class="display nowrap" style="width:100%">
            ...
            <tbody class="text-sm font-thin">
                <tr>
                    ...
                    <td>admin</td>
                    <td class="text-rose-600 font-semibold">Admin</td>
                    <td>
                        <div class="flex items-center space-x-2 text-lg">
                            <button onclick="window.location.href='<?= route_to('usersdata/editusers'); ?>'" class="text-green-500 bg-white p-2 w-8 h-8 flex items-center justify-center rounded-xl">
                                <i class="ri-edit-circle-line"></i>
                            </button>
                            <button id="modalDeleteUsersOpen" class="text-red-500 bg-white p-2 w-8 h-8 flex items-center justify-center rounded-xl">
