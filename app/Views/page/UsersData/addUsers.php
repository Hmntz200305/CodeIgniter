    ...
    <div class="mt-10 mx-auto lg:w-1/2 sm:w-full">
        <form class="space-y-6" method="post" action="<?php echo site_url('usersdata/addusers/addprocess'); ?>">
            ...
            <div class="flex space-x-4">
                <button onclick="window.location.href='<?= route_to('usersdata'); ?>'" type="button" class="text-gray-600 text-sm font-medium hover:text-rose-600 border-l-4 hover:border-rose-600 py-1.5 px-4 rounded">
                    Back
                </button>
