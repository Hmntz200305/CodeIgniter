...
<div class="px-6">
    ...
    <div>
        <?php if (session()->get('id_user_level') == 2) : ?>
            <form action="decissionresult/clearprocess" method="POST" onsubmit="return showConfirmationClearModalDecicionResult(this);">
...
<!-- MODAL CLEAR -->
<div id="modalClearDecissionResult" class="flex fixed inset-0 p-4 flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] hidden">
    <div class="w-full max-w-md bg-white dark:bg-slate-800 shadow-lg rounded-md p-6 relative">
        ...
        <div class="flex justify-center space-x-4">
            ...
            <button type="button" id="modalClearDecissionResultOpen" class="rounded-md bg-rose-600 px-4 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-rose-700">
                Delete
            </button>
        </div>
    </div>
