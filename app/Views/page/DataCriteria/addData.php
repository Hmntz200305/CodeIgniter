...
<div class="px-6">
    <div class="py-4 flex flex-col">
        <span class="text-lg font-bold text-black dark:text-white">Add Data Criteria</span>
    ...
    <div class="mt-10 mx-auto lg:w-1/2 sm:w-full">
        <form class="space-y-6" method="post" action="<?php echo site_url('datacriteria/adddata/addprocess'); ?>">
            ...
            <div>
                <label for="password" class="block text-sm font-medium leading-6 text-gray-600 dark:text-gray-300">Weight (Kg)</label>
                <div class="mt-2 relative w-full min-w-[200px] h-10">
